    ...
    <section className="section-pad">
      <div className="shell story-grid">
        ...
        <div className="long-copy">
          ...
          <p>Diagnostic Ventures licensed technology started in 2017 from research led by Dr. William Pitt and Dr. Richard Robison at Brigham Young University and supported by a 5 year $5.4M NIH grant. The team tackled bioengineering’s needle-in-a-haystack problem: isolating just 5–10 bacterial cells from billions of host cells.</p>
          <p>The team engineered a proprietary centrifuge platform that isolates plasma in under four minutes. Working with BYU and Dr. Robison’s BSL-3 research facilities, Diagnostic Ventures is combining centrifugal isolation, downstream bacterial processing, Raman spectroscopy, and machine learning, targeting 98–99% pathogen identification accuracy.</p>
